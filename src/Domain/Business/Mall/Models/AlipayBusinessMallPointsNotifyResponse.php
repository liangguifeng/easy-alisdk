...
namespace EasyAliSdk\Domain\Business\Mall\Models;

use AlibabaCloud\Tea\Model;

class AlipayBusinessMallPointsNotifyResponse extends Model
{
    /**
     * @description 响应原始字符串
     *
     ...
     * @param array $map
     *
     * @return AlipayBusinessMallPointsNotifyResponse
     */
