...
namespace EasyAliSdk\Domain\Business\Mall;
...
use EasyAliSdk\Domain\Base\User\Models\AlipayUserInfoShareResponse;
...
class Client
{
     ...
     * @param $earnPoints
     * @param $obtainPoints
     * @param $pointsUpdateTime
     * @param $noPointsRemarks
     * @param $totalPoints
     *
     ...
     */
    public function pointNotify($buyerId, $tradeNo, $earnPoints, $obtainPoints, $pointsUpdateTime, $noPointsRemarks, $totalPoints)
    {
        $_runtime = [
        ...
        while (Tea::allowRetry(@$_runtime['retry'], $_retryTimes, $_now)) {
            ...
            try {
                ...
                $systemParams = [
                    'method'              => 'alipay.business.mall.points.notify',
                ...
                $bizParams = [
                    ...
                    'obtain_points'      => $obtainPoints,
                    'points_update_time' => $pointsUpdateTime,
                    'no_points_remarks'  => $noPointsRemarks,
                ...
                $respMap = $this->_kernel->readAsJson($_response, 'alipay.business.mall.points.notify');
